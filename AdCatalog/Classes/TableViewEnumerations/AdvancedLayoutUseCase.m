...
@implementation AdvancedLayoutUseCase

@synthesize controllerClass = controllerClass_;
@synthesize title = title_;

#pragma mark AdvancedLayoutUseCase methods

+ (AdvancedLayoutUseCase *)advancedLayoutUseCaseWithTitle:(NSString *)title
    controllerClass:(Class)controllerClass {
  AdvancedLayoutUseCase *result =
  [[[AdvancedLayoutUseCase alloc] init] autorelease];
  result.title = title;
